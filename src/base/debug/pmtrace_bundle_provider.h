...
#define TRACEPOINT_INCLUDE_FILE base/debug/pmtrace_bundle_provider.h

#if !defined(BASE_DEBUG_PMTRACE_BUNDLE_PROVIDER_H_) || \
    defined(TRACEPOINT_HEADER_MULTI_READ)
#define BASE_DEBUG_PMTRACE_BUNDLE_PROVIDER_H_
...
#endif  /* BASE_DEBUG_PMTRACE_BUNDLE_PROVIDER_H_ */
