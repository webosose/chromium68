...
DECLARE_PMLOG_HEADER(Injection)
DECLARE_PMLOG_HEADER(JSConsole)
DECLARE_PMLOG_HEADER(Memory)
DECLARE_PMLOG_HEADER(Network)
DECLARE_PMLOG_HEADER(Ozone)
DECLARE_PMLOG_HEADER(Raw)
DECLARE_PMLOG_HEADER(SQLiteCookie)
DECLARE_PMLOG_HEADER(UI)
DECLARE_PMLOG_HEADER(V8)
DECLARE_PMLOG_HEADER(V8CodeCache)
