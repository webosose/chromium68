...
#ifndef BASE_TRACE_EVENT_NEVA_LTTNG_PMTRACER_H_
#define BASE_TRACE_EVENT_NEVA_LTTNG_PMTRACER_H_

#if defined(USE_LTTNG)

#include "base/debug/pmtrace_bundle_provider.h"
...
#endif  // BASE_TRACE_EVENT_NEVA_LTTNG_PMTRACER_H_
