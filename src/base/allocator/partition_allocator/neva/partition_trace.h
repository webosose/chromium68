...
#ifndef BASE_ALLOCATOR_PARTITION_ALLOCATOR_NEVA_PARTITION_TRACE_H
#define BASE_ALLOCATOR_PARTITION_ALLOCATOR_NEVA_PARTITION_TRACE_H
...
#endif  // BASE_ALLOCATOR_PARTITION_ALLOCATOR_NEVA_PARTITION_TRACE_H
