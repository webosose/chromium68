...
#ifndef CONTENT_RENDERER_MEDIA_AUDIO_CAPTURER_SOURCE_MANAGER_H
#define CONTENT_RENDERER_MEDIA_AUDIO_CAPTURER_SOURCE_MANAGER_H
...
#endif  // CONTENT_RENDERER_MEDIA_AUDIO_CAPTURER_SOURCE_MANAGER_H
