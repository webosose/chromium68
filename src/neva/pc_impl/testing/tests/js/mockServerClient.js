...
var mockServerClient = function (host, port) {
    ...
    var mockAnyResponse = function (expectation) {
        xmlhttp.open("PUT", mockServerUrl + "/expectation", true);
    ...
    var verify = function (request, count, exact) {
        ...
        xmlhttp.open("PUT", mockServerUrl + "/verify", true);
        xmlhttp.setRequestHeader("Content-Type", "application/json; charset=utf-8");
    ...
    var verifySequence = function () {
        xmlhttp.open("PUT", mockServerUrl + "/verifySequence", true);
        xmlhttp.setRequestHeader("Content-Type", "application/json; charset=utf-8");
        var requestSequence = [];
     ...
     */
    var reset = function () {
        xmlhttp.open("PUT", mockServerUrl + "/reset", true);
        xmlhttp.send("");
        return _this;
    };
    /**
    ...
    var clear = function (pathOrRequestMatcher) {
        xmlhttp.open("PUT", mockServerUrl + "/clear", true);
        xmlhttp.setRequestHeader("Content-Type", "application/json; charset=utf-8");
    ...
    var dumpToLogs = function (pathOrRequestMatcher) {
        xmlhttp.open("PUT", mockServerUrl + "/dumpToLog", true);
        xmlhttp.setRequestHeader("Content-Type", "application/json; charset=utf-8");
        if (typeof pathOrRequestMatcher === "string") {
            xmlhttp.send(JSON.stringify(createResponseMatcher(pathOrRequestMatcher)));
        } else if (pathOrRequestMatcher) {
