...
#ifndef NEVA_APP_RUNTIME_RENDERER_NET_TEMPLATE_BUILDER_H_
#define NEVA_APP_RUNTIME_RENDERER_NET_TEMPLATE_BUILDER_H_
...
#endif  // NEVA_APP_RUNTIME_RENDERER_NET_TEMPLATE_BUILDER_H_
