...
const CSSPropertyID kComputedPropertyArray[] = {
    ...
    CSSPropertyNavIndex, CSSPropertyNavUp, CSSPropertyNavDown,
    CSSPropertyNavLeft, CSSPropertyNavRight, CSSPropertyObjectFit,
    CSSPropertyObjectPosition, CSSPropertyOffsetAnchor,
